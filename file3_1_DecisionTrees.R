...
#Rpart vs CHAID - different libraries for creating decision trees
#Rpart - uses GINI
#CHAID - uses Chi Squared
#CART is supervised learning while CHAID is unsupervised learning
...
set.seed(123)
indx <- createDataPartition(y = data$survived, p = 0.8, list = FALSE)
...
#CP = Complexity Parameter, method=class, for categorical variables
#Complexity Parameter, Min Depth, etc. - used to control the depth of the tree
#Rel error = normal error
