...
#2. Aim is to maximize the within the cluster hmogeneity and reduce the similarity between different groups.
#3. Assigns centroids to the groups, which keeps on getting updated 
